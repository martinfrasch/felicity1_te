#!/usr/bin/env python3
"""
Statistical Analysis for Figures 3, 4, 6, and 7
...
def compute_ratios_and_stats(data_file, conditioning_type):
    ...
    Parameters:
    - data_file: loaded npz file
    - conditioning_type: 'maternal' or 'fetal'
    """
    ...
    for group, name in zip(groups, group_names):
        ...
        # Compute per-subject fractions
        frac_accel = N_accel / N_total
        frac_decel = N_decel / N_total

        # Compute per-subject ratio decel/accel
...
def statistical_tests_accel_decel(mhr_results, fhr_results):
    ...
    Tests:
    1. Figure 3: Overall patterns (comparing accel vs decel fractions)
    2. Figure 4: Group comparisons (stressed vs control, male vs female)
    """
    ...
    for cond_name, results in [('Maternal HR', mhr_results), ('Fetal HR', fhr_results)]:
        ...
        # Test 1: Are accel and decel fractions different from 0.5?
        ...
        # Test 2: Is the decel/accel ratio different from 1?
...
# ============================================================================
# PART 2: Hmax/Hmean Values Analysis (Figures 6 & 7)
# ============================================================================
...
def load_hmax_data():
    ...
    # Load all data into structured format
    hmax_data = {}
    hmean_data = {}
...
def statistical_tests_hmax(hmax_data, hmean_data):
    """
    Perform statistical tests on hmax/hmean data for Figures 6 & 7

    Tests:
    1. Group comparisons: stressed vs control, male vs female
    2. Condition comparisons: conditioning effects
    """
